...
<a class="label label-default" href="<%= sharedLink %>&amp;starts_with=&#1168;">&#1168;</a>
...
<a class="label label-default" href="<%= sharedLink %>&amp;starts_with=&#1028;">&#1028;</a>
<%
for (char c = '\u0416'; c <= '\u0418'; c++)
{
%>
...
%>
<a class="label label-default" href="<%= sharedLink %>&amp;starts_with=&#1030;">&#1030;</a>
<a class="label label-default" href="<%= sharedLink %>&amp;starts_with=&#1031;">&#1031;</a>
<%
for (char c = '\u0419'; c <= '\u0429'; c++)
{
%>
